    ...
    <div class="content">
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="fcstItem">
          <div class="block">
            <h2>YTNB 预测
              <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=YTNB_预测')" >模板下载</a>
              <div class="form-box">
                <upload-new
                  ...
                  :sheetsName="'YTNB_预测'"
                  :tableName='"YTNB_FCST"'
                  :dbName="'FF_IDSS_Data_YT'"
                  :url="'/uploadYTTransfer'"
                  :logTableName='"YTNB_FCST"'
                  :logObj="'FCSTt'">
                </upload-new>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[1]" class="fcstItem">
          <div class="block">
            <h2>YTNB Commit
            <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=YTNB_Commit')" >模板下载</a>
              <div class="form-box">
                <upload-new
                  @on-success="updataCommit"
                  @updateTimeChange="updataCommit1"
                  :sheetsName="'YTNB_Commit'"
                  :dbName="'FF_IDSS_Data_YT'"
                  :url="'/uploadCommitTransfer'"
                  :tableName='"YTNB_Commit"'
                  :logTableName='"YTNB_Commit"'
                  :logObj="'upcommit'">
                </upload-new>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[3]" class="fcstItem">
          <div class="block">
            ...
            <v-table-query
              :params='params1'
              :sheetsName="'YTNB_Commit查询'"
              :tableName='"YTNB_Commit_TTL"'
              :source="'FF_IDSS_Data_CON'"
              :fileName="'YTNB_Commit查询'"
              ref="fcstcomTtl">
            </v-table-query>
          </div>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    getQueryFamily1 () {
      ...
      params['tableName'] = 'YTNB_Commit_TTL'
    ...
    getQueryFamily () {
      ...
      let params = {}
      params['dbName'] = 'FF_IDSS_Data_CON'
      params['tableName'] = 'YTNB_FCST_TTL'
