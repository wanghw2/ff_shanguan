      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        ...
        <el-tab-pane :label="menuArr[1]" class="pdtItem">
          <div class="block">
            <h2>YTNB SO PO Mapping
              ...
              <div class="form-box">
                <updata
                  ...
                  :logTableName="'YTNB_PO_SO_Mapping_PN_Action'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'YTNB_SO_PO_Mapping'"
                :tableName='"YTNB_PO_SO_Mapping_PN_Action"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTNB_SO_PO_Mapping'"
                ref="gridsopomap">
              </v-table>
            </div>
          </div>
    ...
    download2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'YTNB_SO_PO_Mapping_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'YTNB_SO_PO_Mapping'
        },
        done (data) {
          alert(data)
