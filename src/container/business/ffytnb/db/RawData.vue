      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="dbItem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'YTNB_未清PO'"
                :tableName='"YTNB_Open_PO"'
        ...
        <el-tab-pane :label="menuArr[1]" class="dbItem">
          <div class="block">
            ...
            <div class="addcnbSummarize">
              <v-table
                :sheetsName="'YTNB_库存明细'"
                :tableName='"YTNB_Summarize"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTNB_库存明细'"
        ...
        <el-tab-pane :label="menuArr[2]" class="dbItem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'YTNB_欠单明细'"
                :tableName='"YTNB_Unconfirmed"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTNB_欠单明细'"
