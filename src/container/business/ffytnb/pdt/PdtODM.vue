      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="pdtItem">
          <div class="block">
            <h2>YTNB 备货进度
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'302'"
                  :menuName="'投产管理_备货进度'"
                  :logTableName="'YTNB_Replenishment_Report_Overview'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'YTNB_备货进度'"
                :tableName='"YTNB_Replenishment_Report_Overview"'
    ...
    download () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'YTNB_备货进度表_Download'
        },
        done (data) {
          let $a = $('<a></a>')
