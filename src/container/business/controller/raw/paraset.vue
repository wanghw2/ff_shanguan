  ...
  methods: {
    ...
    initTab () { // 初始化表格
      ...
      $(this.$refs.table).kendoGrid({
        ...
        resizable: true,
        excel: {
          fileName: 'RAW_上传表配置参数' + '_' + vm.getDate1() + '.xlsx',
          allPages: true
        },
        pageable: {
          numeric: true,
        ...
        excelExport (e) {
          e.workbook.sheets[0].name = 'RAW_上传表配置参数'
        },
        columns: vm.columns,
        dataSource: {
          data: vm.dataSource,
    ...
    getDataSource () { // 获取表格数据
      ...
      return this.$ajax({
        ...
        method: 'get',
        params: {
          tableName: 'Table_Excel_Upload_Mapping_RAW',
          source: 'FF_IDSS'
        },
        done (data) {
    ...
    uploadFile (e) {
      ...
      data.append('tableName', 'Table_Excel_Upload_Mapping_RAW')
      let vm = this
      this.$ajax({
