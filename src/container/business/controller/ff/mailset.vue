  ...
  data () {
    return {
      columns: [
          ...
          {title: '邮件主题', field: '邮件主题', width: '120px'},
          {title: '附件名', field: '附件名', width: '120px'},
          {title: '收件人', field: '收件人', width: '120px'},
          {title: '抄送人', field: '抄送人', width: '120px'},
          {title: '密送人', field: '密送人', width: '120px'},
          {title: '版本号', field: '版本号', width: '120px'},
          {title: '默认路径', field: '默认路径', width: '120px'},
          {title: '邮件主题版本', field: '邮件主题版本', width: '120px'},
          {title: 'FullFileName', field: 'FullFileName', width: '120px'},
          {title: '测试人', field: '测试人', width: '120px'}
      ],
      dataSource: [],
      fieldsList: [],
      pageSize: 18,
  ...
  methods: {
    ...
    initTab () { // 初始化表格
      ...
      $(this.$refs.table).kendoGrid({
        ...
        resizable: true,
        excel: {
          fileName: 'FF_邮件配置参数' + '_' + vm.getDate1() + '.xlsx',
          allPages: true
        },
        pageable: {
          numeric: true,
        ...
        excelExport (e) {
          e.workbook.sheets[0].name = 'FF_邮件配置参数'
        },
        columns: vm.columns,
        dataSource: {
          data: vm.dataSource,
    ...
    uploadFile (e) {
      ...
      data.append('tableName', 'FF_Mail_loop')
      let vm = this
      this.$ajax({
