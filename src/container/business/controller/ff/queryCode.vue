...
export default {
  data () {
    return {
      columns: [
          {title: 'Code_Name', field: 'Code_Name', width: '120px'},
          {title: 'Code_Value', field: 'Code_Value', width: '120px'},
          {title: 'Sub_Name', field: 'Sub_Name', width: '120px'},
          {title: 'Sub_Value', field: 'Sub_Value', width: '120px'},
          {title: 'Sub_Index', field: 'Sub_Index', width: '120px'},
  ...
  methods: {
    ...
    initTab () { // 初始化表格
      ...
      $(this.$refs.table).kendoGrid({
        ...
        resizable: true,
        excel: {
          fileName: '查询参数' + '_' + vm.getDate1() + '.xlsx',
          allPages: true
        },
        pageable: {
          numeric: true,
    ...
    getDataSource () { // 获取表格数据
      ...
      return this.$ajax({
        ...
        method: 'get',
        params: {
          tableName: 'FF_Query_Code_Mapping',
          source: 'FF_IDSS'
        },
        done (data) {
    ...
    uploadFile (e) {
      ...
      data.append('dbName', 'IDSS')
      data.append('tableName', 'FF_Query_Code_Mapping')
      let vm = this
      this.$ajax({
        url: '/uploadExcelQueryCode',
        headers: {
    ...
    updateconset () {
      this.$refs.thinkconparaset.updateTabFun()
    },
    toggleList () {
