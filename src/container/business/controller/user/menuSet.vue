...
export default {
  data () {
    return {
      columns: [
          {title: 'First_Menu_Name', field: 'First_Menu_Name', width: '120px'},
          {title: 'Second_Menu_Name', field: 'Second_Menu_Name', width: '120px'},
          {title: 'Url', field: 'Url', width: '120px'},
          {title: 'Role_Id', field: 'Role_Id', width: '120px'},
          {title: 'First_Sort', field: 'First_Sort', width: '120px'},
          {title: 'Second_Sort', field: 'Second_Sort', width: '120px'},
  ...
  methods: {
    ...
    initTab () { // 初始化表格
      ...
      $(this.$refs.table).kendoGrid({
        ...
        resizable: true,
        excel: {
          fileName: '菜单上传' + '_' + vm.getDate1() + '.xlsx',
          allPages: true
        },
        pageable: {
          numeric: true,
