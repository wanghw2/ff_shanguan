      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        ...
        <el-tab-pane :label="menuArr[2]" class="fcstItem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'YTDT_Commit'"
                :tableName='"YTDT_Commit"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTDT_Commit'"
                ref="gridupcommit" >
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[4]" class="fcstItem">
          <div class="block">
            ...
            <v-table-query
              :params='params1'
              :sheetsName="'YTDT_Commit查询'"
              :tableName='"YTDT_Commit_TTL"'
              :source="'FF_IDSS_Data_YT'"
              :fileName="'YTDT_Commit查询'"
              ref="fcstcomTtl">
            </v-table-query>
          </div>
        </el-tab-pane>
...
import VTable254 from '@/components/public/vtablePage'
...
export default {
  data () {
    return {
      serverUrl: domainUrl,
      tabPosition: 'left',
      menuArr: ['WW ATS SCI', '预测', 'Commit', '预测查询', 'Commit查询'],
      params: {},
      params1: {},
      form: {
        version: [],
  ...
  methods: {
    ...
    getQueryFamily1 () {
      ...
      params['tableName'] = 'YTDT_Commit_TTL'
    ...
    getQueryFamily () {
      ...
      let params = {}
      params['dbName'] = 'FF_IDSS_Data_CON'
      params['tableName'] = 'YTDT_FCST_TTL'
    ...
    updataFCSTt1 () {
      this.$refs.gridFCST.updateTimeChange()
    },
    updataCommit1 () {
    ...
    updateffwwatssci1 () {
      this.$refs.gridffwwatssci.updateTimeChange()
    }
  }
}
</script>
