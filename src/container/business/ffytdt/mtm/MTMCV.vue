      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="sbbuplod">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'YTDT_物料特征值'"
                :tableName="'YTDT_MTM_CV'"
        ...
        <el-tab-pane :label="menuArr[1]" class="sbbuplod">
          <div class="block">
            <!-- <h2 class="left">YTDT 特征值无标签
              <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=YTDT_特征值无标签')" >下载</a>
            </h2>
            <h2 class="right">YTDT 物料无特征值
              <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=YTDT_物料无特征值')" >下载</a>
            </h2>
            <div class="lpath">
              <div class="btn">
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'YTDT_物料无CV值'"
                :tableName='"YTDT_CV_MTM_Missing"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTDT_物料无CV值'">
              </v-table>
            </div>
            <h2>物料手工CV值
              ...
              <div class="form-box">
                <upload
                  ...
                  :logTableName="'YTDT_CV_MTM_Adjust'"
                  :sheetsName="'YTDT_物料手工CV值'"
            ...
            <div class="addgrid addgrid1">
              <v-table
                :sheetsName="'YTDT_物料手工CV值'"
                :tableName='"YTDT_CV_MTM_Adjust"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTDT_物料手工CV值'"
                ref="thinkFinalPSD2">
              </v-table>
            </div>
          </div>
            ...
            <h2>YTDT CPU标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_CPU标签'"
                  :logTableName='"YTDT_CV_Label_CPU"'
                  :logObj="'cpu'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 显卡标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_显卡标签'"
                  :logTableName='"YTDT_CV_Label_GFX"'
                  :logObj="'gfx'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 硬盘标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_硬盘标签'"
                  :logTableName='"YTDT_CV_Label_HDD"'
                  :logObj="'hdd'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 内存标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_内存标签'"
                  :logTableName='"YTDT_CV_Label_MEM"'
                  :logObj="'mem'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 主板标签
              <div class="form-box">
                <upload
                  ...
                  :logTableName='"YTDT_CV_Label_MB"'
                  :sheetsName="'YTDT_主板标签'"
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 屏幕标签
              <div class="form-box">
                <upload
                  ...
                  :logTableName='"YTDT_CV_Label_Panel"'
                  :sheetsName="'YTDT_屏幕标签'"
                  :logObj="'labelpanel'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT 机箱标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_机箱标签'"
                  :logTableName='"YTDT_CV_Label_MC"'
                  :logObj="'colorMark'">
                </upload>
              </div>
            </h2>
            ...
            <h2>YTDT OS标签
              <div class="form-box">
                <upload
                  ...
                  @on-success="updateLabelMb"
                  @updateTimeChange="updateLabelMb1"
                  :sheetsName="'YTDT_OS标签'"
                  :logTableName='"YTDT_CV_Label_OS"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[10]" class="sbbuplod">
          <div class="block">
            <h2>YTDT Office标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'YTDT_Office标签'"
                  :logTableName='"YTDT_CV_Label_Office"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'YTDT_Office标签'"
                :tableName='"YTDT_CV_Label_Office"'
                :source="'FF_IDSS_Data_YT'"
                :fileName="'YTDT_Office标签'"
                ref="gridOffice" >
              </v-table>
            </div>
          </div>
...
export default {
  ...
  methods: {
    uploadFile (e) {
      ...
      data.append('sheetNames', 'YTDT_CPU标签,YTDT_显卡标签,YTDT_硬盘标签,YTDT_内存标签,YTDT_主板标签,YTDT_屏幕标签,YTDT_颜色标签,YTDT_物料特征值')
      let vm = this
      this.$ajax({
