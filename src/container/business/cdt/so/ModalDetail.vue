...
<div class="orderQuery-show" v-show="isHide">
  ...
  <div class="qResults">
    <div class="qResults-top">
      ...
      <div class="qResults-top-right">
        ...
        <p class="message2">Confirm PN: {{detailDate.Confirm_PN}}</p>
        <p class="message2">Confirm Desc: {{detailDate.Confirm_Desc}}</p>
      </div>
    </div>
  ...
  <div class="block">
    ...
    <div class="sn">
      <v-table251
        :so="so"
        :tableName="'ConNB_Workflow_SN_TTL'"
...
<script>
import VTable251 from '@/components/public/vtable251'
