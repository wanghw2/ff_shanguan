      ...
      <el-tabs :tab-position="'top'" style="height: auto;">
        ...
        <el-tab-pane :label="menuArr[2]" class="fcstItem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_预测版本'"
                :tableName="'ConDT_FCST_Version'"
  ...
  methods: {
    ...
    getQuerydata () { // 获取查询条件（公用接口）
      ...
      vm.$ajax({
        ...
        method: 'get',
        params: {
          'codeValue': '产品细分_CONNB,价位段,Commit_Issue_ConDT'
        },
        done (data) {
          for (let i = 0; i < data.length; i++) {
            ...
            if (data[i].value === 'Commit_Issue_ConDT') {
    ...
    queryfamily1 () { // family1筛选条件的数据
      ...
      let params = {}
      params['dbName'] = 'FF_IDSS_Data_CON'
      params['tableName'] = 'ConDT_FCST_Query_Overview_Base_TTL'
      params['obj0'] = 'Family1'
