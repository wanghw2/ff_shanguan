      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_实时统计'"
                :tableName="'ConDT_RealTime_Inventory'"
        ...
        <el-tab-pane :label="menuArr[1]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_后续可供'"
                :tableName='"ConDT_ToGo_Supply"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_后续可供'"
                ref="gridToGoSupply">
              </v-table>
        ...
        <el-tab-pane :label="menuArr[2]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_产销存'"
                :tableName="'ConDT_DailyReport_Channel_Summary'"
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_产销存'"
        ...
        <el-tab-pane :label="menuArr[3]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_欠单分析'"
                :tableName='"ConDT_Backlog_Analysis_Overview"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_欠单分析'"
                ref="gridBSummary" >
              </v-table>
        ...
        <el-tab-pane :label="menuArr[4]" class="dbitem" >
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_SO_PSD'"
                :tableName='"ConDT_Backlog_Analysis_PN"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_SO_PSD'"
                ref="gridsopsd">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[5]" class="dbitem">
          <div class="block">
            <h2>ConDT 还可来单
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'337'"
                  :menuName="'看板管理_每日看板'"
                  :logTableName="'ConDT_Togo_SO_Overview'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_还可来单'"
                :tableName='"ConDT_Togo_SO_Overview"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_还可来单'"
                ref="gridtogoso">
              </v-table>
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_实时统计_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    download3 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_产销存_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
    ...
    download4 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_欠单分析_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
    ...
    download5 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_SO_PSD_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
    ...
    download6 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_还可来单_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
