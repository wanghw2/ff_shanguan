      ...
      <div class="block">
        ...
        <div class="grid1">
          <v-table-query
            ...
            :sheetsName="'ConDT_SI维度'"
            :tableName='"ConDT_SellOut_Return_Aging_SI"'
        ...
        <div class="grid2">
          <v-table-query
            ...
            :url="'getPushOut'"
            :columnurl="'queryTableColumns251'"
            :sheetsName="'ConDT_SO维度'"
            :tableName='"ConDT_SellOut_Return_Aging_SO"'
            :source="'FF_IDSS_Data_CON'"
            :fileName="'ConDT_SO维度'"
            ref="gridSO">
          </v-table-query>
...
export default {
  ...
  methods: {
    ...
    getQuerycussegment1 () {
      ...
      params['tableName'] = 'ConDT_SellOut_Return_Aging_SI'
      params['obj0'] = '客户细分1'
      params['orderType'] = '1'
      params['checked'] = '1'
      vm.$ajax({
