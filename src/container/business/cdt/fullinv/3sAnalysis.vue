  ...
  methods: {
    ...
    initTab () { // 初始化表格
      ...
      $('.dateView').kendoGrid({
        ...
        excelExport (e) {
          e.workbook.sheets[0].name = 'ConDT_全国SO分布'
        },
    ...
    getCusSegment1s () {
      ...
      params['tableName'] = 'ConDT_3S_Tracking_Detail'
      params['checked'] = '1'
      params['obj0'] = '客户细分1'
      vm.$ajax({
        url: '/querySelCode',
    ...
    getProsegments () {
      let vm = this
      let params = {}
      params['tableName'] = 'ConDT_SellOut_Tracking_Detail'
      params['obj0'] = '产品细分'
      vm.$ajax({
        url: '/querySelFamily',
        data: params,
