      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_管理看板'"
                :tableName="'ConNB_Manage_Report_Supply_Month'"
        ...
        <el-tab-pane :label="menuArr[1]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConDT_管理看板'"
                :tableName="'ConDT_Manage_Report_Supply_Month'"
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConDT_管理看板'"
                ref="griddtmanagerpt">
              </v-table>
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConNB_管理看板_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    download2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConDT_管理看板_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
