      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="sbbuplod">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_物料特征值'"
                :tableName="'ConNB_MTM_CV'"
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_物料特征值'"
                ref="cnbcharac">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[1]" class="sbbuplod">
          <div class="block">
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'ConNB_物料无CV值'"
                :tableName='"ConNB_CV_MTM_Missing"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_物料无CV值'">
              </v-table>
            </div>
            <h2>物料手工CV值
              ...
              <div class="form-box">
                <upload
                  ...
                  :logTableName="'ConNB_CV_MTM_Adjust'"
                  :sheetsName="'ConNB_物料手工CV值'"
            ...
            <div class="addgrid addgrid1">
              <v-table
                :sheetsName="'ConNB_物料手工CV值'"
                :tableName='"ConNB_CV_MTM_Adjust"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_物料手工CV值'"
                ref="thinkFinalPSD2">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[2]" class="sbbuplod">
          <div class="block">
            <h2>ConNB CPU标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_CPU标签'"
                  :logTableName='"ConNB_CV_Label_CPU"'
                  :logObj="'cpu'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_CPU标签'"
                :tableName='"ConNB_CV_Label_CPU"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_CPU标签'"
                ref="gridcpu">
              </v-table>
            </div>
          </div>
            ...
            <h2>ConNB 显卡标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_显卡标签'"
                  :logTableName='"ConNB_CV_Label_GFX"'
                  :logObj="'gfx'">
                </upload>
              </div>
            </h2>
            ...
            <h2>ConNB 硬盘标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_硬盘标签'"
                  :logTableName='"ConNB_CV_Label_HDD"'
                  :logObj="'hdd'">
                </upload>
              </div>
            </h2>
            ...
            <h2>ConNB 内存标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_内存标签'"
                  :logTableName='"ConNB_CV_Label_MEM"'
                  :logObj="'mem'">
                </upload>
              </div>
            </h2>
          ...
          <div class="block">
            <h2>ConNB 屏幕标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_屏幕标签'"
                  :logTableName='"ConNB_CV_Label_Panel"'
                  :logObj="'labelpanel'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_屏幕标签'"
                :fileName="'ConNB_屏幕标签'"
                :tableName='"ConNB_CV_Label_Panel"'
                ref="gridlabelpanel"
                :source="'FF_IDSS_Data_CON'" >
              </v-table>
            </div>
          ...
          <div class="block">
            <h2>ConNB 颜色标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_颜色标签'"
                  :logTableName='"ConNB_CV_Label_Color"'
                  :logObj="'colorMark'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_颜色标签'"
                :fileName="'ConNB_颜色标签'"
                :tableName='"ConNB_CV_Label_Color"'
                ref="gridsbbuplod"
                :source="'FF_IDSS_Data_CON'" >
              </v-table>
            </div>
            ...
            <h2>ConNB OS标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_OS标签'"
                  :logTableName='"ConNB_CV_Label_OS"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[9]" class="sbbuplod">
          <div class="block">
            <h2>ConNB Office标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_Office标签'"
                  :logTableName='"ConNB_CV_Label_Office"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_Office标签'"
                :tableName='"ConNB_CV_Label_Office"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_Office标签'"
                ref="gridOffice" >
              </v-table>
            </div>
          </div>
