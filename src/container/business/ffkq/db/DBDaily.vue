      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'KQ_实时统计'"
                :tableName="'KQ_RealTime_Inventory'"
        ...
        <el-tab-pane :label="menuArr[1]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'KQ_PSD_Update'"
                :tableName='"KQ_PSD_Update"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'KQ_PSD_Update'"
                ref="gridToGoSupply">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[2]" class="dbitem">
          <div class="block">
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'KQ_欠单分析_GSC'"
                :tableName='"KQ_Backlog_Analysis_GSC_Family"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'KQ_欠单分析_GSC'"
                ref="gridBackloggsc" >
              </v-table>
            </div>
          </div>
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'KQ_实时统计_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    download2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'KQ_后续可供_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
    ...
    download3 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'KQ_欠单分析_GSC_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
