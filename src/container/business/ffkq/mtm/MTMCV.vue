    ...
    <div class="content">
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        ...
        <el-tab-pane :label="menuArr[1]" class="sbbuplod">
          <div class="block">
            <!-- <h2 class="left">KQ 特征值无标签
              <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=KQ_特征值无标签')" >下载</a>
            </h2>
            <h2 class="right">KQ 物料无特征值
              <a class="small" :href="serverUrl+'/downloadExcelByTN?'+encodeURI('tableName=KQ_物料无特征值')" >下载</a>
            </h2>
            <div class="lpath">
              <div class="btn">
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'KQ_物料无CV值'"
                :tableName='"KQ_CV_MTM_Missing"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'KQ_物料无CV值'">
              </v-table>
            </div>
            <h2>物料手工CV值
              ...
              <div class="form-box">
                <upload
                  ...
                  :logTableName="'KQ_CV_MTM_Adjust'"
                  :sheetsName="'KQ_物料手工CV值'"
            ...
            <h2>KQ 屏幕标签
              <div class="form-box">
                <upload
                  ...
                  :logTableName='"KQ_CV_Label_Panel"'
                  :sheetsName="'KQ_屏幕标签'"
                  :logObj="'labelpanel'">
                </upload>
              </div>
        ...
        <el-tab-pane :label="menuArr[10]" class="sbbuplod">
          <div class="block">
            <h2>KQ Office标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'KQ_Office标签'"
                  :logTableName='"KQ_CV_Label_Office"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'KQ_Office标签'"
                :tableName='"KQ_CV_Label_Office"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'KQ_Office标签'"
                ref="gridOffice" >
              </v-table>
            </div>
          </div>
...
export default {
  ...
  methods: {
    uploadFile (e) {
      ...
      data.append('sheetNames', 'KQ_CPU标签,KQ_显卡标签,KQ_硬盘标签,KQ_内存标签,KQ_主板标签,KQ_屏幕标签,KQ_颜色标签,KQ_物料特征值')
      let vm = this
      this.$ajax({
