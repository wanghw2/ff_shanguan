...
export default {
  ...
  methods: {
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ZY_PSD_Report_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'ZY_PSD_Report'
        },
        done (data) {
          alert(data)
    ...
    updatezypsd () {
      this.$refs.gridzypsd.updateTabFun()
    },
    updateTogosupply () {
