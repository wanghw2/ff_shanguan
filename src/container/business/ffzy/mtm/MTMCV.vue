        ...
        <el-tab-pane :label="menuArr[1]" class="sbbuplod">
          <div class="block">
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'ZY_物料无CV值'"
                :tableName='"ZY_CV_MTM_Missing"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'ZY_物料无CV值'">
              </v-table>
            </div>
            <h2>物料手工CV值
              ...
              <div class="form-box">
                <upload
                  ...
                  :logTableName="'ZY_CV_MTM_Adjust'"
                  :sheetsName="'ZY_物料手工CV值'"
            ...
            <h2>ZY 屏幕标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ZY_屏幕标签'"
                  :logTableName='"ZY_CV_Label_Panel"'
                  :logObj="'labelpanel'">
                </upload>
              </div>
            </h2>
            ...
            <h2>ZY 颜色标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ZY_颜色标签'"
                  :logTableName='"ZY_CV_Label_Color"'
                  :logObj="'colorMark'">
                </upload>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[9]" class="sbbuplod">
          <div class="block">
            <h2>ZY Office标签
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ZY_Office标签'"
                  :logTableName='"ZY_CV_Label_Office"'
                  :logObj="'mb'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ZY_Office标签'"
                :tableName='"ZY_CV_Label_Office"'
                :source="'FF_IDSS_Data_REL'"
                :fileName="'ZY_Office标签'"
                ref="gridOffice" >
              </v-table>
            </div>
          </div>
