...
export default {
  ...
  methods: {
    getperiData () {
      let peri = this.$refs.peri
      let periCharts = echarts.init(peri)
      var symbols = [
    ...
    getsunburstData () {
      let sunburst = this.$refs.sunburst
      let sunburstCharts = echarts.init(sunburst)
      let vm = this
      var sunburstData = []
      vm.$ajax({
        url: '/sunburstChart',
        method: 'get',
          ...
          sunburstData = [].concat(data.data)
          // console.log(sunburstData)
          sunburstCharts.setOption({
            title: {
              text: '太阳图',
              subtext: 'sunburst',
              textStyle: {
