      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="family">
          <div class="block">
            ...
            <div class="addTarget">
              <v-table
                :sheetsName="'Tablet_Family'"
                :tableName="'Tablet_MTM_Family'"
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'Tablet_Family'">
              </v-table>
            </div>
          </div>
        </el-tab-pane>
        <el-tab-pane :label="menuArr[1]" class="family">
          <div class="block">
            <h2>Tablet Family对应关系
              <div class="form-box">
                <upload
                  @on-success="updateFamilyMap"
                  @updateTimeChange="updateFamilyMap1"
                  :sheetsName="'Tablet_Family对应关系'"
                  :logTableName="'Tablet_Family'"
            ...
            <div class="addgrid">
              <v-table
                :sheetsName="'Tablet_Family对应关系'"
                :tableName="'Tablet_Family'"
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'Tablet_Family对应关系'"
                ref="gridFamilyMap">
              </v-table>
            </div>
          </div>
