        ...
        <el-tab-pane :label="menuArr[0]" class="tarItem">
          <div class="block">
            <h2>Tablet ROL Date
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'Tablet_ROL_Date'"
                  :logTableName="'Tablet_ROL_Date'"
                  :logObj="'gridroldate'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'Tablet_ROL_Date'"
                :tableName="'Tablet_ROL_Date'"
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'Tablet_ROL_Date'"
                ref="gridroldate">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[1]" class="tarItem">
          <div class="block">
            <h2>Tablet InvTime
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'Tablet_InvTime'"
                  :logTableName="'Tablet_invtime'"
                  :logObj="'gridinvtime'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'Tablet_InvTime'"
                :tableName="'Tablet_invtime'"
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'Tablet_InvTime'"
                ref="gridinvtime">
              </v-table>
            </div>
          </div>
