...
export default {
  ...
  methods: {
    ...
    drawChart1 () {
      ...
      params['tableName'] = 'ConNB_3S_Tracking_Week_Stock_WOI_Query'
    ...
    getColumns1 () { // 获取表格的列名
      ...
      return this.$ajax({
        ...
        method: 'get',
        params: {
          tableName: 'ConNB_3S_Tracking_Week_Stock_WOI_Query',
    ...
    initTab1 () { // 初始化表格
      ...
      $(this.$refs.table1).kendoGrid({
        ...
        resizable: true,
        excel: {
          fileName: 'ConNB_库存周转' + '_' + vm.getDate1() + '.xlsx',
          allPages: true
        },
        excelExport (e) {
          e.workbook.sheets[0].name = 'ConNB_库存周转'
        },
