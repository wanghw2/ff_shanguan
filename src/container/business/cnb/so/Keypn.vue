      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="npiItem">
          <div class="block">
            <h2>ConNB 客户岗反馈
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'ConNB_客户岗反馈'"
                  :logTableName='"ConNB_Customer_Key_PN"'
                  :logObj="'gridkeypnup'">
                </upload>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_客户岗反馈'"
                :tableName='"ConNB_Customer_Key_PN"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_客户岗反馈'"
                ref="gridkeypnup">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[1]" class="npiItem">
          <div class="block">
            <h2>ConNB 客户重点机型监控
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'378'"
                  :menuName="'客户重点机型_监控'"
                  :logTableName="'ConNB_Customer_Key_PN_Report'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_促销监控'"
                :tableName='"ConNB_Customer_Key_PN_Report"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_促销监控'"
    ...
    download () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConNB_客户重点机型监控_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'ConNB_客户重点机型监控'
        },
        done (data) {
          alert(data)
