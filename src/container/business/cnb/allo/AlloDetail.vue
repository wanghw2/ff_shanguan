      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="alloItem">
          <div class="block">
            <h2>ConNB 分货结果
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'236'"
                  :menuName="''"
                  :logTableName="'ConNB_Alloc_Analysis'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_分货结果'"
                :tableName="'ConNB_Alloc_Analysis'"
        ...
        <el-tab-pane :label="menuArr[1]" class="alloItem">
          <div class="block">
            <h2>ConNB 分货欠单明细
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'236'"
                  :menuName="''"
                  :logTableName="'ConNB_Alloc_Openbacklog'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_分货欠单明细'"
                :tableName="'ConNB_Alloc_Openbacklog'"
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_分货欠单明细'"
                ref="gridAllo2">
              </v-table>
            </div>
          </div>
