      ...
      <el-tabs :tab-position="tabPosition" style="height: auto;">
        <el-tab-pane :label="menuArr[0]" class="pdtItem">
          <div class="block">
            <h2>ConNB 营销策略
              <div class="form-box">
                <Upload
                  :sheetsName="'ConNB_营销策略'"
                  @on-success="updatemostr"
                  @updateTimeChange="updatemostr1"
                  :logTableName="'ConNB_MO_Strategy'"
                  :logObj="'gridmostr'">
                </Upload>
              </div>
            </h2>
        ...
        <el-tab-pane :label="menuArr[1]" class="pdtItem">
          <div class="block">
            <h2>ConNB SO PO Mapping
              ...
              <div class="form-box">
                <updata
                  ...
                  :logTableName="'ConNB_PO_SO_Mapping_PN_Action'"
                  :proIndex="'2'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_SO_PO_Mapping'"
                :tableName='"ConNB_PO_SO_Mapping_PN_Action"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_SO_PO_Mapping'"
                ref="gridsopomap">
              </v-table>
            </div>
          </div>
        ...
        <el-tab-pane :label="menuArr[2]" class="pdtItem">
          <div class="block">
            <h2>ConNB 供需分析
              ...
              <div class="form-box">
                <updata
                  ...
                  :menuId="'371'"
                  :menuName="'供应管理_供需分析'"
                  :logTableName="'ConNB_Supply_Analysis_SO_PN'"
                  :proIndex="'1'" >
                </updata>
              </div>
            </h2>
            <div class="addgrid">
              <v-table
                :sheetsName="'ConNB_供需分析'"
                :tableName='"ConNB_Supply_Analysis_SO_PN"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_供需分析'"
                ref="gridSupAnalysis">
              </v-table>
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConNB_供需分析表_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    download2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConNB_SO_PO_Mapping_Download'
        },
        done (data) {
          let $a = $('<a></a>')
          $a.attr('href', data)[0].click()
    ...
    sendemail2 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'ConNB_SO_PO_Mapping'
        },
        done (data) {
          alert(data)
          vm.disabledemail = false
