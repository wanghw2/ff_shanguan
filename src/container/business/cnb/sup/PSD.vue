        ...
        <el-tab-pane :label="menuArr[0]" class="supitem">
          <div class="block">
            ...
            <h2>ConNB PSD
              ...
              <a :class="['small', 'emailBtn', {'disabled': disabledemail}]" @click="sendemail1" href="#">ConNB邮件</a>
              <a :class="['small', {'disabled': disableddownload}]" class="small downBtn" @click="download1" href="#">下载</a>
            </h2>
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'ConNB_PSD_Detail'"
                :tableName="'ConNB_PSD_Detail'"
                :source="'FF_IDSS_Data_CON'"
                :fileName="'ConNB_PSD_Detail'"
                ref="gridconnbpsd">
              </v-table>
            </div>
            <h2>ConNB 后续可供
          ...
          <div class="block">
            ...
            <div class="addgrid addgrid7">
              <v-table
                ...
                :tableName='"ConNB_GEO_Order_Candence"'
                :source="'FF_IDSS_Data_CON'"
            ...
            <div class="addgrid addgrid8">
              <v-table
                :sheetsName="'Input分析'"
                :tableName='"ConNB_Input_Analysis"'
                :source="'FF_IDSS_Data_CON'"
                :fileName="'Input分析'">
              </v-table>
            </div>
...
export default {
  ...
  methods: {
    sendemail0 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'LBG_NB_PSD_Report'
        },
        done (data) {
          alert(data)
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'ConNB_PSD_Report_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'ConNB_PSD_Report'
        },
        done (data) {
          alert(data)
          vm.disabledemail = false
    ...
    updatePSDReport () {
      this.$refs.gridlbgnbpsd.initTabTable()
      this.$refs.gridconnbpsd.initTabTable()
    },
    updatePSDReport1 () {
      this.$refs.gridlbgnbpsd.updateTimeChange()
      this.$refs.gridconnbpsd.updateTimeChange()
    },
    gagueBoarddata () {
      let vm = this
      vm.$ajax({
