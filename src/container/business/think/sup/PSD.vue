        ...
        <el-tab-pane :label="menuArr[0]" class="supitem">
          <div class="block">
            <h2>Think PSD 手工
              ...
              <div class="form-box">
                <upload
                  :sheetsName="'Think_PSD_Upload'"
                  @on-success="updatePSDReport"
                  @updateTimeChange="updatePSDReport1"
                  :logTableName="'Think_PSD_Upload'"
                  :logObj="'gridthinkpsdup'">
                </upload>
              </div>
            </h2>
            <div class="addgrid addgrid1">
              <v-table
                :sheetsName="'Think_PSD_Upload'"
                :tableName="'Think_PSD_Upload'"
                :source="'FF_IDSS_Data_Think'"
                :fileName="'Think_PSD_Upload'"
                ref="gridthinkpsdup">
              </v-table>
            </div>
            <h2>Think PSD
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'Think_Final_PSD'"
                :tableName="'Think_Final_PSD'"
                :source="'FF_IDSS_Data_Think'"
                :fileName="'Think_Final_PSD'"
                :allPages="false"
                ref="gridThinkpsd">
              </v-table>
            </div>
          ...
          <div class="block">
            ...
            <div class="addgrid addgrid7">
              <v-table
                ...
                :tableName='"Think_GEO_Order_Candence"'
                :source="'FF_IDSS_Data_Think'"
            ...
            <div class="addgrid addgrid8">
              <v-table
                :sheetsName="'Input分析'"
                :tableName='"Think_Input_Analysis"'
                :source="'FF_IDSS_Data_Think'"
                :fileName="'Input分析'">
              </v-table>
            </div>
...
export default {
  ...
  methods: {
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'Think_PSD_Report_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'Think_PSD_Report'
        },
        done (data) {
          alert(data)
    ...
    updatePSDReport () {
      this.$refs.gridthinkpsdup.initTabTable()
      this.$refs.gridThinkpsd.initTabTable()
    },
    updatePSDReport1 () {
      this.$refs.gridthinkpsdup.updateTimeChange()
      this.$refs.gridThinkpsd.updateTimeChange()
    },
    gagueBoarddata () {
      let vm = this
      vm.$ajax({
