        ...
        <el-tab-pane :label="menuArr[0]" class="fcstItem">
          <div class="block">
            <h2>DT 预测Commit
              ...
              <div class="form-box">
                <upload
                  :sheetsName="'Think_DT_预测Commit'"
                  @on-success="updateFcstcommit"
                  @updateTimeChange="updateFcstcommit1"
                  :logTableName='"Think_DT_FCST_Commit"'
                  :logObj="'gridFcstcommit'" >
                </upload>
              </div>
            </h2>
            <div class="addgrid addgrid1">
              <v-table
                :sheetsName="'Think_DT_预测Commit'"
                :fileName="'Think_DT_预测Commit'"
                :tableName='"Think_DT_FCST_Commit"'
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'Think_DT_预测'"
                :fileName="'Think_DT_预测'"
                :tableName='"Think_DT_FCST"'
                :source="'FF_IDSS_Data_Think'" 
                ref="gridFcst">
              </v-table>
            </div>
            ...
            <div class="addgrid addgrid3">
              <v-table
                :sheetsName="'Think_DT_Commit'"
                :fileName="'Think_DT_Commit'"
                :tableName='"Think_DT_Commit"'
                :source="'FF_IDSS_Data_Think'" 
                ref="gridcommit">
              </v-table>
            </div>
        ...
        <el-tab-pane :label="menuArr[1]" class="fcstItem">
          <div class="block">
            ...
            <div class="addgrid addgrid4">
              <v-table
                :sheetsName="'Think_DT_预测Commit_汇总'"
                :fileName="'Think_DT_预测Commit_汇总'"
                :tableName='"Think_DT_FCST_Commit_TTL"'
                :source="'FF_IDSS_Data_Think'" 
                ref="gridFcstcommitttl">
              </v-table>
            </div>
            <h2>DT 预测 汇总
            ...
            <div class="addgrid addgrid5">
              <v-table
                :sheetsName="'Think_DT_预测_汇总'"
                :fileName="'Think_DT_预测_汇总'"
                :tableName='"Think_DT_FCST_TTL"'
                :source="'FF_IDSS_Data_Think'" 
                ref="gridFcstttl">
              </v-table>
            </div>
            ...
            <div class="addgrid addgrid6">
              <v-table
                :sheetsName="'Think_DT_Commit_汇总'"
                :fileName="'Think_DT_Commit_汇总'"
                :tableName='"Think_DT_Commit_TTL"'
                :source="'FF_IDSS_Data_Think'" 
                ref="gridcommitttl">
              </v-table>
            </div>
        ...
        <el-tab-pane :label="menuArr[2]" class="fcstItem">
          <div class="block">
            <h2>DT CPU分货
              ...
              <div class="form-box">
                <upload
                  ...
                  :sheetsName="'Think_DT_CPU分货'"
                  :logTableName='"Think_DT_CPU_Allocation"'
                  :logObj="'gridcpualloc'">
                </upload>
              </div>
            </h2>
            <div class="addgrid addgrid7">
              <v-table
                :sheetsName="'Think_DT_CPU分货'"
                :tableName='"Think_DT_CPU_Allocation"'
                :source="'FF_IDSS_Data_Think'"
                :fileName="'Think_DT_CPU分货'"
                ref="gridcpualloc">
              </v-table>
            </div>
            <h2>DT CPU分货 汇总
            ...
            <div class="addgrid addgrid8">
              <v-table
                :sheetsName="'Think_DT_CPU分货_汇总'"
                :tableName='"Think_DT_CPU_Allocation_TTL"'
                :source="'FF_IDSS_Data_Think'"
                :fileName="'Think_DT_CPU分货_汇总'"
                ref="gridcpuallocttl">
              </v-table> 
            </div>  
          </div>
...
export default {
  data () {
    return {
      ...
      toggle8: true,
      tabPosition: 'left',
      menuArr: ['DT 预测Commit', 'DT 预测Commit 汇总', 'DT CPU分货']
    }
  },
  components: {
    Upload,
  ...
  methods: {
    ...
    updateFcstcommit () { // 上传后自动刷新表格数据
      this.$refs.gridFcstcommit.updateTabFun()
      this.$refs.gridFcst.updateTabFun()
      this.$refs.gridcommit.updateTabFun()
      this.$refs.gridFcstttl.updateTabFun()
      this.$refs.gridcommitttl.updateTabFun()
      this.$refs.gridFcstcommitttl.updateTabFun()
    },
    updateFcstcommit1 () {
      this.$refs.gridFcstcommit.updateTimeChange()
    },
    updatecpualloc () {
