    ...
    <el-form ref="form" class="formBoxContent" :model="form" label-width="80px" size="mini">
      <div class="item2">
        <el-form-item label="SO" prop="so" class="item41">
          <el-input v-model="form.so" ></el-input>
        </el-form-item>
        <el-form-item label="物料编码" prop="matCode" class="item21">
            <el-input v-model="form.matCode" ></el-input>
        </el-form-item>
        <el-form-item label="渠道编码" prop="bpCode" class="item21">
          <el-input v-model="form.bpCode"  ></el-input>
        </el-form-item>
        ...
        <el-form-item label="业务线" prop="thinkBusiness" class="item25" >
          <el-select v-model="form.thinkBusiness" multiple collapse-tags placeholder="请选择">
            <el-option
              v-for="item in thinkBusiness.children"
              :key="item.value"
              :label="item.name"
              :value="item.value">
            </el-option>
        ...
        <el-form-item label="业务类型" prop="businessType" class="item25" >
          <el-select v-model="form.businessType" multiple collapse-tags placeholder="请选择">
            <el-option
              v-for="item in businessType.children"
              :key="item.value"
              :label="item.name"
              :value="item.value">
            </el-option>
      ...
      <div class="item2">
        ...
        <el-form-item label="物料描述" prop="matDesc" class="item21">
            <el-input v-model="form.matDesc" ></el-input>
        </el-form-item>
        <el-form-item label="渠道名称" prop="bpName" class="item21">
          <el-input v-model="form.bpName"  ></el-input>
        </el-form-item>
        <el-form-item label="物料类型" prop="matType" class="item21" >
          <el-select v-model="form.matType" multiple collapse-tags placeholder="请选择">
            <el-option
      ...
      <div class="item2">
        <el-form-item label="产品组" prop="productGroup" class="item21" >
          <el-select v-model="form.productGroup" multiple collapse-tags placeholder="请选择">
            <el-option
              v-for="item in productGroup.children"
              :key="item.value"
              :label="item.name"
              :value="item.value">
            </el-option>
        ...
        <el-form-item label="采购订单" prop="pOrderNumber" class="item21">
            <el-input v-model="form.pOrderNumbe" ></el-input>
        </el-form-item>
      </div>
      <div class="fold">
      ...
      <div class="innerbox">
        <div class="item2">
          ...
          <el-form-item label="ND" prop="nd" class="item21">
            <el-select v-model="form.nd" multiple collapse-tags placeholder="请选择">
              <el-option
                v-for="item in nd.children"
                :key="item.value"
                :label="item.name"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="ISID" prop="isID" class="item26">
            <el-input v-model="form.isID" ></el-input>
          </el-form-item>
        ...
        <div class="item2">
          ...
          <el-form-item label="急单标识" prop="urgentIdentify"  class="item21" >
            <el-select v-model="form.urgentIdentify" multiple ref="urgentIdentify1" collapse-tags  placeholder="请选择">
              <el-option
                v-for="item in urgentIdentify.children"
                :key="item.value"
                :label="item.name"
                :value="item.value">
              </el-option>
          ...
          <el-form-item label="familyECC" prop="familyECC" class="item26" >
            <el-input v-model="form.familyECC" ></el-input>
          </el-form-item>
          <el-form-item label="CRAD" prop="CRAD" class="item24" >
        ...
        <div class="item2">
          ...
          <el-form-item label="急单描述" prop="urgentDesc"  class="item21">
            <el-input v-model="form.urgentDesc" ></el-input>
          </el-form-item>
          <el-form-item label="重点机型标识" prop="keyModelIdentify" class="item26" >
            <el-select v-model="form.keyModelIdentify" multiple collapse-tags placeholder="请选择">
              <el-option
                v-for="item in keyModelIdentify.children"
                :key="item.value"
                :label="item.name"
                :value="item.value">
              </el-option>
        ...
        <div class="item2">
          ...
          <el-form-item label="商机编号" prop="bONumber" class="item21">
            <el-input v-model="form.bONumber" ></el-input>
          </el-form-item>
          <el-form-item label="重点机型描述" prop="keyModelDesc" class="item26" >
            <el-input v-model="form.keyModelDesc" ></el-input>
          </el-form-item>
        ...
        <div class="item2">
          ...
          <el-form-item label="最终客户" prop="finalCust" class="item21">
            <el-input v-model="form.finalCust" ></el-input>
          </el-form-item>
          <el-form-item label="订单交付类型" prop="orderDType" class="item26" >
            <el-select v-model="form.orderDType" multiple collapse-tags placeholder="请选择">
              <el-option
                v-for="item in orderDType.children"
                :key="item.value"
                :label="item.name"
                :value="item.value">
              </el-option>
...
export default {
  ...
  methods: {
    ...
    valieForm () { // params参数
      let params = {}
      if (this.form.urgentDesc !== '') {
        params['urgentDesc'] = this.form.urgentDesc.replace(/ /g, ',').split(',')
      }
      if (this.form.so !== '') {
        params['so'] = this.form.so.replace(/ /g, ',').split(',')
      }
      if (this.form.familyECC !== '') {
        params['familyECC'] = this.form.familyECC.replace(/ /g, ',').split(',')
      }
      if (this.form.pOrderNumber !== '') {
        params['pOrderNumber'] = this.form.pOrderNumber.replace(/ /g, ',').split(',')
      }
      if (this.form.finalCust !== '') {
        params['finalCust'] = this.form.finalCust.replace(/ /g, ',').split(',')
      }
      if (this.form.isID !== '') {
        params['isID'] = this.form.isID.replace(/ /g, ',').split(',')
      }
      if (this.form.keyModelDesc !== '') {
        params['keyModelDesc'] = this.form.keyModelDesc.replace(/ /g, ',').split(',')
      }
      ...
      if (this.form.bONumber !== '') {
        params['bONumber'] = this.form.bONumber.replace(/ /g, ',').split(',')
      }
      ...
      if (this.form.urgentIdentify.join() !== '') {
        params['urgentIdentify'] = this.form.urgentIdentify
      }
      ...
      if (this.form.nd.join() !== '') {
        params['nd'] = this.form.nd
      }
      if (this.form.productGroup.join() !== '') {
        params['productGroup'] = this.form.productGroup
      }
      if (this.form.keyModelIdentify.join() !== '') {
        params['keyModelIdentify'] = this.form.keyModelIdentify
      }
      ...
      if (this.form.thinkBusiness.join() !== '') {
        params['thinkBusiness'] = this.form.thinkBusiness
      }
      if (this.form.businessType.join() !== '') {
        params['businessType'] = this.form.businessType
      }
      if (this.form.orderDType.join() !== '') {
        params['orderDType'] = this.form.orderDType
      }
      ...
      if (isnull) {
        params['init'] = 0
        params['dbName'] = 'FF_IDSS_Data_Think'
        params['tName'] = 'Think_SaleOrder_ttl'
        params['vid'] = this.vid
      }
      if (!isnull) {
        params['dbName'] = 'FF_IDSS_Data_Think'
    ...
    getQuerydata () { // 获取查询条件
      ...
      vm.$ajax({
        ...
        method: 'get',
        params: {
          'codeValue': '通路_0002,Think业务线_Think,业务类型_Think,订单状态_0001,物料类型_0001,订单类型_0001,订单原因_Think,产品组_Think,ND_Think,急单标识_Think,重点机型标识_Think,订单交付类型_Think,来单工厂_Think,发货工厂_Think,CRAD_0001,PSD_0001'
        },
        done (data) {
          for (let i = 0; i < data.length; i++) {
            if (data[i].value === '产品组_Think') {
              vm.productGroup = data[i]
            }
            ...
            if (data[i].value === 'ND_Think') {
              vm.nd = data[i]
            }
            if (data[i].value === '发货工厂_Think') {
              vm.fhFactory = data[i]
            }
            if (data[i].value === '来单工厂_Think') {
              vm.tcFactory = data[i]
            }
            if (data[i].value === '物料类型_0001') {
              vm.matType = data[i]
            }
            if (data[i].value === '订单原因_Think') {
              vm.orderReason = data[i]
            }
            if (data[i].value === '订单交付类型_Think') {
              vm.orderDType = data[i]
            }
            if (data[i].value === 'Think业务线_Think') {
              vm.thinkBusiness = data[i]
            }
            if (data[i].value === '业务类型_Think') {
              vm.businessType = data[i]
            }
            ...
            if (data[i].value === '急单标识_Think') {
              vm.urgentIdentify = data[i]
            }
            if (data[i].value === '重点机型标识_Think') {
              vm.keyModelIdentify = data[i]
            }
          }
        },
        fail (msg) {
...
.orderQuery
  ...
  .formBox
    ...
    .item2
      overflow hidden
      width 100%
      .item21,.item22,.item23,.item31,.item41,.item24,.item25, .item26
        float left
        width 192px
        margin-left -10px
        .item221
