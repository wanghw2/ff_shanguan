  ...
  <div class="db-box">
    <div class="content">
      <el-tabs :tab-position="tabPosition" style="height: auto;" @tab-click="tabClick">
        ...
        <el-tab-pane :label="menuArr[3]" @click="getListData4" class="dbItem">
          <div class="block">
            <h2>显示器_工厂</h2>
            <template>
              <el-table
                :data="tableData4.slice((currentPage4-1)*pagesize4,currentPage4*pagesize4)"
                :row-style="tableRowStyle"
                style="width: 100%">
                <el-table-column prop="fileName" width="500%" label="文件名称" class="column1">
                  <template slot-scope="scope">
        ...
        <el-tab-pane :label="menuArr[4]" @click="getListData5" class="dbItem">
          <div class="block">
            <h2>显示器_工厂</h2>
            <template>
              <el-table
                :data="tableData5.slice((currentPage5-1)*pagesize5,currentPage5*pagesize5)"
                :row-style="tableRowStyle"
                style="width: 100%">
                <el-table-column prop="fileName" width="500%" label="文件名称" class="column1">
                  <template slot-scope="scope">
...
export default {
  data () {
    return {
      ...
      tableData4: [],
      tableData5: [],
      menuArr: ['主机_MTM', '显示器_MTM', '主机_CV', '主机_工厂', '显示器_工厂']
    }
  },
  created () {
    this.getListData1()
