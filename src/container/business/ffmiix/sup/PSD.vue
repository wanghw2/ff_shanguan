        ...
        <el-tab-pane :label="menuArr[0]" class="supitem">
          <div class="block">
            ...
            <div class="addgrid addgrid1">
              <v-table
                :sheetsName="'MIIX_PSD_Detail'"
                :tableName="'MIIX_PSD_Detail'"
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'MIIX_PSD_Detail'"
                :allPages="false"
                ref="gridMIIXpsd">
              </v-table>
            </div>
            ...
            <div class="addgrid addgrid2">
              <v-table
                :sheetsName="'MIIX_PSD_Update'"
                :tableName='"MIIX_PSD_Update"'
                :source="'FF_IDSS_Data_Tablet'"
                :fileName="'MIIX_PSD_Update'"
                ref="gridTogosupply">
              </v-table>
            </div>
          </div>
          ...
          <div class="block">
            ...
            <div class="addgrid addgrid7">
              <v-table
                ...
                :tableName='"MIIX_GEO_Order_Candence"'
                :source="'FF_IDSS_Data_Tablet'"
    ...
    download1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 0,
          DOWNLOAD_BAT_PATH: 'MIIX_PSD_Report_Download'
        },
        done (data) {
          let $a = $('<a></a>')
    ...
    sendemail1 () {
      ...
      vm.$ajax({
        ...
        params: {
          type: 1,
          ismail: 1,
          SENDMAIL_BAT_PATH: 'MIIX_PSD_Report'
        },
        done (data) {
          alert(data)
